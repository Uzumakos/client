   ...
   return (
     <div className={style.wrapper}>
         <div className={style.searchBar}>
             ...
             <input 
             type="text" 
             placeholder="Chache sou Twitè" 
             className={style.inputBox}
             />
         </div>
         <div className={style.section}>
           <div className={style.title}>Sakap regle?</div>
           {news.map((item, index) => (
           ...
           <div className={style.showMore}>Montre plis</div>
         </div>
         <div className={style.section}>
           <div className={style.title}>Kiyès pou swiv</div>
           {whoToFollow.map((item, index) => (
             <div key={index} className={style.item}>
               ...
               <div className={style.followButton}>Swiv</div>
             </div>
           ))}
         </div>
     </div>
